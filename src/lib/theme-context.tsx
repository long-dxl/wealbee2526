...
const THEMES: Record<ThemeId, Theme> = {
  light: {
    ...
    fg: "#1A1A2E",              fgMuted: "rgba(26,26,46,0.60)",
    fgSubtle: "rgba(26,26,46,0.45)",                        fgDisabled: "rgba(26,26,46,0.30)",
  ...
  dark: {
    ...
    fg: "rgba(240,242,255,0.90)",                           fgMuted: "rgba(240,242,255,0.55)",
    fgSubtle: "rgba(240,242,255,0.35)",                     fgDisabled: "rgba(240,242,255,0.22)",
  ...
  midnight: {
    ...
    fg: "rgba(220,220,255,0.92)",                           fgMuted: "rgba(220,220,255,0.52)",
    fgSubtle: "rgba(220,220,255,0.32)",                     fgDisabled: "rgba(220,220,255,0.18)",
